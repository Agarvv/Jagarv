...
import com.app.jagarv.repository.
...
public class ProductOpinionService {
    ...
    public ProductOpinionService(ProductRepository productRepository, SecurityOutil securityOutil, UserRepository userRepository) 
    {
